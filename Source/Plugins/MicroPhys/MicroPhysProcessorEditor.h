...
#ifndef MICROPHYSPROCESSOREDITOR_H_INCLUDED
#define MICROPHYSPROCESSOREDITOR_H_INCLUDED
...
/**
    ...
    @see GenericEditor
*/
class MicroPhysProcessorEditor : public GenericEditor    //Generic Editor adds listeners for buttons and sliders.
...
public:
    ...
    MicroPhysProcessorEditor (GenericProcessor* parentNode, bool useDefaultParameterEditors);

    /** The class destructor, used to deallocate memory */
    ~MicroPhysProcessorEditor();
...
private:
    ...
    MicroPhysProcessorContentComponent content;
    ...
    */
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MicroPhysProcessorEditor);
};

#endif // MICROPHYSPROCESSOREDITOR_H_INCLUDED
