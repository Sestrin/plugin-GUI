...
NeuralUDPEditor::NeuralUDPEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors = true)
...
NeuralUDPEditor::~NeuralUDPEditor()
{
}
...
*/
void NeuralUDPEditor::buttonEvent(Button* button)
{
	/*	
