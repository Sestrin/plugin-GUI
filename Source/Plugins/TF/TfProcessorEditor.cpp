...
TfProcessorEditor::TfProcessorEditor (GenericProcessor* parentNode, bool useDefaultParameterEditors = true)
...
TfProcessorEditor::~TfProcessorEditor()
{
}


void TfProcessorEditor::resized()
{
...
*/
void TfProcessorEditor::buttonEvent (Button* button)
{
...
*/
void TfProcessorEditor::sliderEvent (Slider* slider)
{
}
