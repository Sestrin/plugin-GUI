...
#ifndef TFPROCESSOREDITOR_H_INCLUDED
#define TFPROCESSOREDITOR_H_INCLUDED

#include <EditorHeaders.h>
#include <AllLookAndFeels.h>
#include "TfProcessorContentComponent.h"
...
/**
    ...
    @see GenericEditor
*/
class TfProcessorEditor : public GenericEditor    //Generic Editor adds listeners for buttons and sliders.
...
public:
    ...
    TfProcessorEditor (GenericProcessor* parentNode, bool useDefaultParameterEditors);
...
private:
    ...
    TfProcessorContentComponent content;
    ...
    */
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TfProcessorEditor);
};

#endif // TFPROCESSOREDITOR_H_INCLUDED
