...
extern "C" EXPORT int getPluginInfo (int index, Plugin::PluginInfo* info)
{
    switch (index)
    {
        ...
        case 0:
            ...
            //For processor
            info->processor.name = "TF"; //Processor name shown in the GUI
            ...
            //info->processor.type = info->processor.type = Plugin::FilterProcessor;;
            info->processor.type = Plugin::FilterProcessor;

            //Class factory pointer. Replace "ExampleProcessor" with the name of your class.
            info->processor.creator = &(Plugin::createProcessor<TfProcessor>);
        break;
        /**
