...
extern "C" EXPORT void getLibInfo (Plugin::LibraryInfo* info)
{
    ...
    info->name = "MicroPhys plugin library";
...
extern "C" EXPORT int getPluginInfo (int index, Plugin::PluginInfo* info)
{
    switch (index)
    {
        ...
        case 0:
            ...
            //For processor
            info->processor.name = "MicroPhys"; //Processor name shown in the GUI
            ...
            //info->processor.type = info->processor.type = Plugin::SourceProcessor;;
            info->processor.type = Plugin::SourceProcessor;

            //Class factory pointer. Replace "ExampleProcessor" with the name of your class.
            info->processor.creator = &(Plugin::createProcessor<MicroPhysProcessor>);
        break;
        /**
